...
Los dos retrievers ven el mismo corpus —los fragmentos que la ingesta escribió en Chroma y en
el índice léxico— así que describen la misma base y la fusión dedupica por contenido. El
léxico encuentra la cita escrita literal, que el embedding diluye entre párrafos parecidos; el
